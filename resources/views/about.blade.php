...
@section('main')
 <!--About details start-->
        <section class="crd-details ptb-120">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="crd-details-content">
                            ...
                            <p>Bên cạnh đó, cộng đồng Node & Validator VietNam cũng có một trang web chính thức và các trang mạng xã hội như Facebook và Telegram để giữ liên lạc với các thành viên. Các thành viên có thể tìm thấy thông tin về các sự kiện sắp diễn ra, bài viết về blockchain và cập nhật về các dự án blockchain mới nhất trên trang web và các trang mạng xã hội của cộng đồng.</p>
                        ...
                        <div class="crd-details-content"><br>
                            ...
                            <p>In addition, the Node & Validator VietNam community also has an official website and social media pages such as Facebook and Telegram to stay in touch with members. Members can find information on upcoming events, blockchain articles, and updates on the latest blockchain projects on the community's website and social media pages.</p>
                            <p>Furthermore, the community provides specific guidance on more complex technical issues related to installing and operating validator nodes. New members can find useful information on how to handle errors and technical issues, such as resolving network connection loss or enhancing security.</p>
                            <p>Thanks to the guidance and support of the Node & Validator VietNam community, new members can quickly access and participate in node and validator operations on blockchain protocols. Additionally, the community is ready to assist developers and businesses who want to run validators on blockchain protocols.</p>
                        </div>
                    </div>
                </div>
